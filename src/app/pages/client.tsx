      ...
      {status === "authenticated" ? (
        <>
          <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
            ...
            <button onClick={() => signOut()} className="font-mono font-bold">
              Sign out
            </button>
            <div className="fixed bottom-0 left-0 flex h-8 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
              <a
                ...
                href="https://github.com/theaholtlund"
                target="_blank"
                rel="noopener noreferrer"
              >
                By {"Thea Holtlund Jacobsen"}
                <Image
                  src="/logo-2.webp"
                  alt="Polar App Logo"
                  width={100}
          ...
          <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
            {/* Links and information sections here, unchanged */}
            {/* Docs link */}
            <a
            ...
            {/* Other sections like Learn, Templates, and Deploy unchanged */}
          </div>
        </>
      ) : (
